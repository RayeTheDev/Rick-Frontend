...
export const FirstNews = () => {
  ...
  useEffect(() => {
    client.get("user/" + data[0].creatorId).then((res) => {
      setUser(res.data);
    });
  }, [data]);
  return (
    <div className={menu ? styles.controller : `${styles.controller_none}`}>
      ...
      <div className={styles.content_container}>
        <div
          className={styles.news_image_con}
          onClick={() => {
            Navigate("/news/" + data[0]._id);
          }}>
        ...
        <div className={styles.news_container}>
          <div
            ...
            <div className={styles.news_name}>{data[0].title}</div>
            <div className={styles.creator}>
              ...
              <div className={styles.creater_info}>
                ...
                <div className={styles.creator_post_date}>
                  {data[0].createdAt.slice(5, 7) +
                    "-р сарын " +
                    data[0].createdAt.slice(8, 10) +
                    " - " +
                    data[0].createdAt.slice(0, 4)}{" "}
