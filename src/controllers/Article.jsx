  ...
  return (
    data && (
      <>
        <Header />
        <div
          className={styles.article_right}
          onClick={() => Navigate("/news/" + props.item._id)}>
            ...
            <div className={styles.creator_con}>
              <div className={styles.creator_name}>
                ...
                <div className={styles.date}>
                  {props.item.createdAt.slice(5, 7) +
                    "-р сарын " +
                    props.item.createdAt.slice(8, 10) +
                    " - " +
                    props.item.createdAt.slice(0, 4)}{" "}
                  <BsDot className={styles.dot_icon} /> 2 мин
                </div>
              </div>
            ...
            <div className={styles.article_title}>
              <div className={styles.title}>
                <div className={styles.title_type}>
                  {props.item.category[0].name}
                </div>
                <div className={styles.title_name}>{props.item.title}</div>
              </div>
              <img
                className={styles.article_image}
                src={props.item.photoUrl}></img>
            </div>
          </div>
        </div>
      </>
