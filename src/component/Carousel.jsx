...
export const Carousell = (props) => {
  ...
  const ImgOverlayExample = (props) => {
    return (
      <Card className={`bg-dark text-white ${styles.CardImg}`} style={{backgroundImage:`url("${photo1}")`,backgroundRepeat:"no-repeat",backgroundSize:"cover",backgroundPosition:"center",borderRadius:"15px"}} >
